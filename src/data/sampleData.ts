    ...
    questions: [
      {
        ...
        correctAnswer: 40, // 40%
        points: 10,
        explanation: "매출총이익률은 (매출총이익 / 매출액) × 100으로 계산합니다. 이 기업의 경우 40%입니다."
      },
      {
        id: "q1-2",
        ...
        correctAnswer: 14, // 14%
        points: 10,
        explanation: "영업이익률은 (영업이익 / 매출액) × 100으로 계산합니다. 이 기업의 경우 14%입니다."
      },
      {
        id: "q1-3",
        ...
        correctAnswer: 12, // 12%
        points: 10,
        explanation: "당기순이익률은 (당기순이익 / 매출액) × 100으로 계산합니다. 이 기업의 경우 12%입니다."
      },
      {
        id: "q1-4",
        ...
        correctAnswer: "예, 투자하기 적합합니다",
        points: 20,
        explanation: "이 기업의 수익성 지표들은 산업 평균 이상으로, 안정적인 수익을 내고 있어 투자에 적합합니다."
      }
    ],
    ...
    questions: [
      {
        ...
        points: 10,
        explanation: "부채비율은 (총부채 / 자기자본) × 100으로 계산합니다. 이 기업의 경우 150%입니다."
      },
      {
        id: "q2-2",
        text: "이 기업의 유동비율(Current Ratio)은 얼마인가요?",
        type: "NUMERIC",
        correctAnswer: 1.5, // 1.5배
        points: 10,
        explanation: "유동비율은 유동자산 / 유동부채로 계산합니다. 이 기업의 경우 1.5배입니다."
      },
      {
        id: "q2-3",
        text: "이 기업의 이자보상배율(Interest Coverage Ratio)은 얼마인가요?",
        type: "NUMERIC",
        correctAnswer: 4.5, // 4.5배
        points: 15,
        explanation: "이자보상배율은 영업이익 / 이자비용으로 계산합니다. 이 기업의 경우 4.5배입니다."
      },
      {
        id: "q2-4",
  ...
  // 레벨 3 미션 - 두 번째 (중간 난이도)
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: "NUMERIC",
        correctAnswer: 2.0, // (유동자산 1억 7500만 - 재고자산 1000만) / 유동부채 7500만 = 약 2.0
        points: 20,
        explanation: "당좌비율은 (유동자산 - 재고자산) / 유동부채로 계산합니다. 이 기업의 경우 약 2.0입니다."
      },
      {
        id: "q3-2-3",
  ...
  // 레벨 4 미션 - 첫 번째 (중간 난이도)
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctAnswer: "A기업",
        points: 15,
        explanation: "A기업의 영업이익 성장률은 30%로, B기업(22%)과 C기업(20%)보다 높습니다."
      },
      {
        id: "q3-3",
